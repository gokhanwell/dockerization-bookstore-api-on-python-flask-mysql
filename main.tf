...
resource "aws_instance" "tf-docker-ec2" {
  ...
  key_name        = "firstkey"
  security_groups = ["gokhanwell-docker-sec-gr"]
  tags = {
    Name = "gokhanwell-Web Server of Bookstore"
  }
  user_data  = <<-EOF
          #! /bin/bash
          yum update -y
          ...
          TOKEN="XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
          FOLDER="https://$TOKEN@raw.githubusercontent.com/gokhanwell/bookstore-repo/main/"
